...
TEST_CASE("TestCase1 : Stream Valid Data From Sensor") {
    ...
    REQUIRE(streamMainFunction(sensorDataInput, tempthresoldValues, socthresoldValues)==1);
}
...
TEST_CASE("TestCase2 : Stream InValid Data From Sensor and check whether the value is being rectified before streaming") {
    ...
    REQUIRE(streamMainFunction(sensorDataInputInvalid, tempthresoldValues, socthresoldValues)==1);
}
